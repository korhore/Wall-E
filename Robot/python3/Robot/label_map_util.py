...
def create_categories_from_labelmap(label_map_path, gfile, use_display_name=True):
  ...
  Returns:
    categories: a list of dictionaries representing all possible categories.
  """
  label_map = load_labelmap(path=label_map_path, gfile=gfile)
  max_num_classes = max(item.id for item in label_map.item)
  return convert_label_map_to_categories(label_map, max_num_classes,
                                         use_display_name)


def create_category_index_from_labelmap(label_map_path, gfile, use_display_name=True):
  ...
  """
  categories = create_categories_from_labelmap(label_map_path=label_map_path,
                                               gfile=gfile,
